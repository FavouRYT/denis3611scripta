        ...
        public static void SetCharacterSkin(IPlayer player)
        {
            try
            {
                ...
                if (chars != null)
                {
                    ...
                    player.SetHeadBlendData((uint)headblendsdata[0], (uint)headblendsdata[1], 0, (uint)headblendsdata[2], (uint)headblendsdata[5], 0, headblendsdata[3], headblendsdata[4], 0);
